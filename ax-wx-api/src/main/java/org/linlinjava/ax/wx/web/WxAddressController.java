...
import org.linlinjava.ax.wx.service.GetRegionService;
...
public class WxAddressController extends GetRegionService {
	...
	public Object list(@LoginUser Integer userId) {
		...
		List<AxAddress> addressList = addressService.queryByUid(userId);
	...
	public Object detail(@LoginUser Integer userId, @NotNull Integer id) {
		...
		AxAddress address = addressService.query(userId, id);
		if (address == null) {
	...
	private Object validate(AxAddress address) {
	 ...
	 */
	@PostMapping("save")
	public Object save(@LoginUser Integer userId, @RequestBody AxAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
	 ...
	 */
	@PostMapping("delete")
	public Object delete(@LoginUser Integer userId, @RequestBody AxAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
