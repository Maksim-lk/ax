...
import org.linlinjava.ax.core.util.CharUtil;
...
import org.linlinjava.ax.db.service.CouponAssignService;
...
import org.linlinjava.ax.wx.dto.UserToken;
import org.linlinjava.ax.wx.dto.WxLoginInfo;
import org.linlinjava.ax.wx.service.CaptchaCodeManager;
import org.linlinjava.ax.wx.service.UserTokenManager;
import org.linlinjava.ax.core.util.IpUtil;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<AxUser> userList = userService.queryByUsername(username);
        AxUser user = null;
        if (userList.size() > 1) {
    ...
    public Object loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, HttpServletRequest request) {
        ...
        AxUser user = userService.queryByOid(openId);
        if (user == null) {
            user = new AxUser();
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        if (userList.size() == 1) {
            AxUser checkUser = userList.get(0);
    ...
    public Object reset(@RequestBody String body, HttpServletRequest request) {
        ...
        List<AxUser> userList = userService.queryByMobile(mobile);
        AxUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
